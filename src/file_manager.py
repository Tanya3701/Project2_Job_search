...
class FileManager(ABC):
    ...
    @abstractmethod
    def write_vacancies(self, *args, **kwargs):
...
class FileManagerJson(FileManager):
    ...
    def __init__(self, vacancies_path = data_file):
        self.__vacancies_path = vacancies_path

    def write_vacancies(self, data_vacancies):
    ...
    def delete_vacancies(self, key_words):
        ...
        with open(self.__vacancies_path, 'r', encoding='utf-8') as file:
            ...
            for word in key_words:
                for item in all_data:
                    if word.lower() in item['Наименование'].lower() or word.lower() in item['Общие требования'].lower():
...
class FileManagerCsv(FileManager):
    ...
    def __init__(self, vacancies_path = '../data/vacancies.csv'):
...
if __name__ == '__main__':
    ...
    data = vacancy.create_vacancy(data_v)
    ...
    print(file_manager.add_vacancies(vacancies))
    # print(file_manager.load_vacancies( ))
    # print(file_manager.delete_vacancies('Специалист'))
    # file_manager_csv = FileManagerJson()
    # file_manager_csv.write_vacancies(vacancies)
    # print(file_manager_csv.load_vacancies())
    # print(file_manager_csv.delete_vacancies(['Специалист', 'senior', 'стажер']))
